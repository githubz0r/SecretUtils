...
Comment 4, kind of.
Distribution of distances per cell type, supposed to be inter-patient for a specific fraction, but we don't have that so we can try healthy vs eps instead. Maybe we could also just try intra sample, just need to split resulting df.
```{r}
min_cells=0
